        ...
        <div class="mb-3 row">
          ...
          <div class="col-sm-10">
            <select class="form-select <?php echo in_array("eiga", array_keys($errors)) ? "is-invalid" : "" ?>" name="eiga" id="eiga" value="<?php echo $_POST['eiga']; ?>">
              ...
              <option <?php if ($_POST["eiga"] === 'ポケットモンスター') echo " selected"; ?> value="ポケットモンスター">ポケットモンスター</option>
              <option <?php if ($_POST["eiga"] === 'ハリーポッター') echo " selected"; ?> value="ハリーポッター">ハリーポッター</option>
              <option <?php if ($_POST["eiga"] === '名探偵コナン') echo " selected"; ?> value="名探偵コナン">名探偵コナン</option>
            </select>
          </div>
        </div>
        <div class="mb-3 row">
